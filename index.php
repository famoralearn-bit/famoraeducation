...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <p class="hero-desc">
            FamoraLearn adalah platform belajar matematika interaktif dengan Tutor FamorAI, materi lengkap, latihan soal yang menarik dan komunitas pelajar aktif. Dari kelas X sampai kelas XII — semua ada di sini.
        </p>
        <div class="hero-cta">
